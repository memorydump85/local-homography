...
public class ProjectionEdge extends GEdge
{
    /* each correspondence is: worldx, worldy, imagex, imagey */
    public ArrayList<double[]> correspondences;
    public String name;

    public ProjectionEdge(ArrayList<double[]> correspondences, String name)
    {
    ...
    public double getResidual(Graph g, double corr[])
    {
        ...
        ExtrinsicsNode ex = (ExtrinsicsNode) g.nodes.get(nodes[2]);
        IDistortionNode distort = (IDistortionNode) g.nodes.get(nodes[1]);
